...
class GuestRepository private constructor(context: Context) {
    ...
    companion object {
        ...
        private lateinit var repository: GuestRepository //essa varável guarda a instância da classe
    ...
    /**
     * Function to catch only one user
     */
    fun get(id: Int): GuestModel? {
        ...
        return try {
            ...
            /**
             * Get values ​​from column NAME and PRESENCE
             */
    ...
    fun getAll(): List<GuestModel> {
        ...
        return try {
            val db = mGuestDataBaseHelper.readableDatabase //leitura do banco de dados
